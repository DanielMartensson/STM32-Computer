...
@ options passed: -mcpu=cortex-a7 -mfloat-abi=soft -mthumb -mno-unaligned-access -mtls-dialect=gnu -march=armv7ve -g3 -Os -std=gnu11 -ffunction-sections -fdata-sections -funwind-tables -fno-short-enums -fno-common
	.text
.Ltext0:
...
.Ldebug_macro0:
	...
	.byte	0x4
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.0.9c75e51a7465332f0af08498916440c1,comdat
.Ldebug_macro2:
	.2byte	0x5
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF463
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.conf.h.2.8cef4b482bc6424f88c9d0255d8baf0f,comdat
.Ldebug_macro3:
	.2byte	0x5
	.byte	0
	.byte	0x5
...
.Ldebug_macro16:
	...
	.4byte	.LASF1413
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.trace.h.14.e67646cb777e7100284aeacbea3e9bf6,comdat
.Ldebug_macro17:
	.2byte	0x5
	.byte	0
	.byte	0x5
...
.LASF2316:
	...
	.ascii	"ata-sections -funwind-tables -fno-short-enums -fno-"
	.ascii	"common\000"
.LASF80:
...
.LASF1433:
	...
	.ascii	"ll) = { .func = (fn), .level = (lvl), .func_name = "
	.ascii	"#fn, }\000"
.LASF476:
...
.LASF679:
	.ascii	"CFG_TEE_CORE_LOG_LEVEL 3\000"
.LASF953:
...
.LASF1466:
	.ascii	"assert(expr) ((expr) ? (void)0 : _assert_trap(#expr"
	.ascii	", __FILE__, __LINE__, __func__))\000"
.LASF686:
