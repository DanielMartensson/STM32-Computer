...
@ options passed: -mcpu=cortex-a7 -mfloat-abi=soft -mthumb -mno-unaligned-access -mtls-dialect=gnu -march=armv7ve -g3 -O0 -std=gnu11 -ffunction-sections -fdata-sections -fno-short-enums -fno-common
	.text
.Ltext0:
...
@ core/arch/arm/kernel/asm-defines.c:17: 	DEFINE(SM_NSEC_CTX_R0, offsetof(struct sm_nsec_ctx, r0));
	.loc 1 17 2
	.syntax unified
...
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:44: 	DEFINE(THREAD_CORE_LOCAL_SIZE, sizeof(struct thread_core_local));
	.loc 1 44 2
@ 44 "core/arch/arm/kernel/asm-defines.c" 1
	
.ascii "==>THREAD_CORE_LOCAL_SIZE 32 sizeof(struct thread_core_local)"	@
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:46: 	DEFINE(SM_PM_CTX_SIZE, sizeof(struct sm_pm_ctx));
	.loc 1 46 2
@ 46 "core/arch/arm/kernel/asm-defines.c" 1
	
.ascii "==>SM_PM_CTX_SIZE 80 sizeof(struct sm_pm_ctx)"	@
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:125: 	DEFINE(THREAD_CTX_SIZE, sizeof(struct thread_ctx));
	.loc 1 125 2
@ 125 "core/arch/arm/kernel/asm-defines.c" 1
	
.ascii "==>THREAD_CTX_SIZE 784 sizeof(struct thread_ctx)"	@
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:132: 	DEFINE(THREAD_CORE_LOCAL_TMP_STACK_VA_END,
	.loc 1 132 2
...
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:134: 	DEFINE(THREAD_CORE_LOCAL_CURR_THREAD,
	.loc 1 134 2
...
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:136: 	DEFINE(THREAD_CORE_LOCAL_FLAGS,
	.loc 1 136 2
@ 136 "core/arch/arm/kernel/asm-defines.c" 1
	
.ascii "==>THREAD_CORE_LOCAL_FLAGS 24 offsetof(struct thread_core_local, flags)"	@
@ 0 "" 2
@ core/arch/arm/kernel/asm-defines.c:138: 	DEFINE(THREAD_CORE_LOCAL_ABT_STACK_VA_END,
	.loc 1 138 2
...
.Ldebug_macro0:
	...
	.uleb128 0
	.uleb128 0x1
	.file 2 "/home/lubuntu/Dokument/GitHub/STM32-Computer/Firmware/STM32-Computer-Firmware/CA7/optee-os-3.19.0-r2/optee-os-stm32mp-3.19.0-stm32mp-r2/../build/stm32mp151a-stm32-computer-firmware-mx/include/generated/conf.h"
	.byte	0x3
	.uleb128 0
	.uleb128 0x2
	.byte	0x7
	...
	.file 42 "/home/lubuntu/Dokument/GitHub/STM32-Computer/Firmware/STM32-Computer-Firmware/CA7/optee-os-3.19.0-r2/optee-os-stm32mp-3.19.0-stm32mp-r2/../build/stm32mp151a-stm32-computer-firmware-mx/core/include/generated/arm32_sysreg.h"
	.byte	0x3
	.uleb128 0xb0
	.uleb128 0x2a
	.byte	0x5
	...
	.byte	0x4
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.0.8ebbff850d6b5aacfd574623ae66e072,comdat
.Ldebug_macro2:
	.2byte	0x5
	.byte	0
	.byte	0x5
	...
	.4byte	.LASF463
	.byte	0
	.section	.debug_macro,"G",%progbits,wm4.conf.h.2.c291d1bd544c6574f44c2393fd50d68a,comdat
.Ldebug_macro3:
	.2byte	0x5
	.byte	0
	.byte	0x5
...
.LASF2193:
	.ascii	"long int\000"
.LASF513:
	.ascii	"CFG_EMBED_DTB_SOURCE_FILE stm32mp151a-stm32-compute"
	.ascii	"r-firmware-mx.dts\000"
.LASF886:
...
.LASF2198:
	...
	.ascii	"=armv7ve -g3 -O0 -std=gnu11 -ffunction-sections -fd"
...
.LASF464:
	...
	.ascii	"151a_stm32_computer_firmware_mx_include_generated_c"
	.ascii	"onf_h_ \000"
.LASF1474:
