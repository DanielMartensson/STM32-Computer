...
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:16: 	DEFINE(PM_CTX_RESUME_PA, OFFSET_OF_CTX_STRUCT(resume_pa));
	.loc 1 16 2
	.syntax unified
...
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:17: 	DEFINE(PM_CTX_TEERAM_BKP_PA, OFFSET_OF_CTX_STRUCT(teeram_bkp_pa));
	.loc 1 17 2
@ 17 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_TEERAM_BKP_PA 4 OFFSET_OF_CTX_STRUCT(teeram_bkp_pa)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:18: 	DEFINE(PM_CTX_CRYP1_BASE, OFFSET_OF_CTX_STRUCT(cryp1_base));
	.loc 1 18 2
@ 18 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_CRYP1_BASE 8 OFFSET_OF_CTX_STRUCT(cryp1_base)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:19: 	DEFINE(PM_CTX_RCC_BASE, OFFSET_OF_CTX_STRUCT(rcc_base));
	.loc 1 19 2
@ 19 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_RCC_BASE 12 OFFSET_OF_CTX_STRUCT(rcc_base)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:20: 	DEFINE(PM_CTX_STGEN_BASE, OFFSET_OF_CTX_STRUCT(stgen_base));
	.loc 1 20 2
@ 20 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_STGEN_BASE 16 OFFSET_OF_CTX_STRUCT(stgen_base)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:21: 	DEFINE(PM_CTX_STGEN_CNT, OFFSET_OF_CTX_STRUCT(stgen_cnt));
	.loc 1 21 2
@ 21 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_STGEN_CNT 20 OFFSET_OF_CTX_STRUCT(stgen_cnt)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:22: 	DEFINE(PM_CTX_CCM_KEY, OFFSET_OF_CMM_CTX_STRUCT(key));
	.loc 1 22 2
@ 22 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_CCM_KEY 40 OFFSET_OF_CMM_CTX_STRUCT(key)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:23: 	DEFINE(PM_CTX_CCM_CTR1, OFFSET_OF_CMM_CTX_STRUCT(ctr1));
	.loc 1 23 2
@ 23 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_CCM_CTR1 72 OFFSET_OF_CMM_CTX_STRUCT(ctr1)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:24: 	DEFINE(PM_CTX_CCM_B0, OFFSET_OF_CMM_CTX_STRUCT(b0));
	.loc 1 24 2
@ 24 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_CCM_B0 88 OFFSET_OF_CMM_CTX_STRUCT(b0)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:25: 	DEFINE(PM_CTX_CCM_CTR0, OFFSET_OF_CMM_CTX_STRUCT(ctr0));
	.loc 1 25 2
@ 25 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_CCM_CTR0 104 OFFSET_OF_CMM_CTX_STRUCT(ctr0)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:26: 	DEFINE(PM_CTX_CCM_TAG, OFFSET_OF_CMM_CTX_STRUCT(tag));
	.loc 1 26 2
@ 26 "core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c" 1
	
.ascii "==>PM_CTX_CCM_TAG 120 OFFSET_OF_CMM_CTX_STRUCT(tag)"	@
@ 0 "" 2
@ core/arch/arm/plat-stm32mp1/pm/context_asm_defines.c:27: 	DEFINE(PM_CTX_CCM_REF_TAG, OFFSET_OF_CTX_STRUCT(ccm_ref_tag));
	.loc 1 27 2
...
.Ldebug_macro0:
	...
	.4byte	.Ldebug_macro5
	.byte	0x4
	.file 6 "/home/lubuntu/Program/STM32/SDK/sysroots/x86_64-ostl_sdk-linux/usr/lib/arm-ostl-linux-gnueabi/gcc/arm-ostl-linux-gnueabi/12.3.0/include/stdbool.h"
	.byte	0x3
	.uleb128 0xb
	.uleb128 0x6
	.byte	0x7
	...
	.4byte	.Ldebug_macro8
	.byte	0x4
	.file 9 "/home/lubuntu/Program/STM32/SDK/sysroots/x86_64-ostl_sdk-linux/usr/lib/arm-ostl-linux-gnueabi/gcc/arm-ostl-linux-gnueabi/12.3.0/include/stddef.h"
	.byte	0x3
	.uleb128 0xd
	.uleb128 0x9
	.byte	0x7
